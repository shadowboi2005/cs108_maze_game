...
def draw(display_surface, time):
    ...
    colour_1 = pygame.Color((0, 0, 0, 200))
    ...
    colour_2 = pygame.Color((255, 255, 255, 255))
    ...
    radial_grad = pygame.transform.smoothscale(radial_grad_starter, (time, time))
    ...
    for i in range(0, circular_smoothness_steps):
        ...
        pos_rect = pygame.Rect((0, 0), (400, 400))
